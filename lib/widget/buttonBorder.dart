...
class IButtonBorder extends StatelessWidget {
  ...
  final Widget? icon;
  final bool? border;
  IButtonBorder({required this.pressButton, this.text, this.color, this.textStyle, this.colorBackgroud, this.icon, required this.pressButtonWithId, this.id, this.border});
