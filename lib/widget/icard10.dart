...
import 'package:courierx/widget/istars.dart';
...
class ICard10 extends StatefulWidget {
  ...
  ICard10({
    ...
    this.image = "",
    this.stars = 0,
    this.colorStars = Colors.black,
    this.id = "",
    this.starsCount = 0,
    this.title,
    this.body,
    required this.callback,
    required this.callbackNavigateIcon,
  });
      ...
      child: Stack(
        children: <Widget>[
          ...
          InkWell(
              ...
              child: Container(
                  ...
                  margin: EdgeInsets.only(
                      left: 5, right: 5, top: widget.height * 0.6),
                  child: Column(
          ...
          UnconstrainedBox(
              child: Container(
                  margin: EdgeInsets.only(
                      left: widget.width - 70, top: widget.height - 55),
                  height: 40,
                  width: 40,
                  child: _route())),
        ],
