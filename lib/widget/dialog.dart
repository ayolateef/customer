...
class EasyDialog{
  ...
  late Color? colorTitle;
  late bool ?bodyLine;
  late Color? colorBackground;
  late Color? colorTitleText;
  late String?text;
  late Widget?body;
  late String?okText;
  late TextStyle? okTextStyle;
  late Color? okColor;
  late double? indent;
  late Function()? callbackPressOk;
  late bool? okButtonText;
  late String? cancelText;
  late Color? cancelColor;
  late TextStyle? cancelTextStyle;
  late Function? callbackPressCancel;
  late bool? cancelButtonText;
  late bool? alignBottom;
  late bool? closeOnBackgroundTap;
  late bool? stars;
  late Function(int)? starsCallback;
  ...
  late Widget _title = Container();
  late Widget _body = Container();
  late bool _line1 = true;
  late bool _line2 = false;
  late DialogScreen _dialog;
  late bool _stars = false;
  ...
  show(BuildContext context){
    ...
    Color? _titleColor = _backgroundColor;
    if (titleLine != null)
      _line1 = titleLine!;
    if (colorTitle != null)
  ...
  // RaisedButton({Color? color, required Null Function() onPressed, required Text child}) {}
