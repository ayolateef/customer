...
class _ICard14State extends State<ICard14> {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.textStyle4 != null) _textStyle4 = widget.textStyle4!;
    double width2 = widget.width > 800 ? 400 : widget.width;
    return InkWell(
        onTap: () {
        ...
        child: Container(
          margin: EdgeInsets.only(
              ...
              top: 10,
              bottom: 10,
              right: widget.width > 800 ? widget.width * 0.4 : 10),
          width: widget.width > 800 ? 600 * 0.3 : widget.width - 10,
          ...
          child: Stack(
            children: <Widget>[
              Hero(
                  ...
                  child: Container(
                      width:
                          widget.width > 800 ? 400 * 0.3 : widget.width * 0.3,
              ...
              InkWell(
                  ...
                  child: Container(
                    width: widget.width,
                    height: widget.height,
                    margin: EdgeInsets.only(top: 5, left: width2 * 0.3 + 5),
                    child: Column(
