...
import 'package:courierx/widget/ilabelWithIcon.dart';
...
class ICard1 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    TextStyle? _dateStyle = TextStyle(fontSize: 16);
        ...
        children: <Widget>[
          Row(
            children: <Widget>[
              Container(
                child: CircleAvatar(
                    backgroundImage: AssetImage(userAvatar!), radius: 35),
                margin:
