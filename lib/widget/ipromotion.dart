...
class _PromotionState extends State<IPromotion> {
  ...
  @override
  void initState() {
    if (widget.seconds != null) _seconds = widget.seconds!;
  ...
  _sale2(Promotion item, int index) {
    ...
    if (widget.style != null) _style = widget.style;
    ...
    TextStyle? _styleButton = TextStyle(fontSize: 20);
    if (widget.buttonTextStyle != null) _styleButton = widget.buttonTextStyle;
    if (widget.buttonText != null)
      _button = IButtonBorder(
          text: widget.buttonText,
          color: Colors.white,
          colorBackgroud: _colorActivy,
          border: false,
          textStyle: _styleButton,
          pressButtonWithId: widget.pressButton,
          id: item.id, pressButton: () {  },);
        ...
        Align(
            ...
            child: Container(
                margin: EdgeInsets.only(
                    left: _width * 0.4, top: 20, right: 20, bottom: 30),
                child: Column(
  ...
  Widget build(BuildContext context) {
    if (widget.colorActivy != null) _colorActivy = widget.colorActivy!;

    if (widget.colorGrey != null) _colorGrey = widget.colorGrey!;
