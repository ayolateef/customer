...
class _IBottomBarState extends State<IBottomBar> {
  ...
  _bottomBar() {
    double height = 60;
    double height1 = windowWidth > 800 ? 70 : 60;
    double marginTop = 30;
    double width = windowWidth / 5;
    double iconSize = width * 0.4;
    double iconSize1 = windowWidth > 800 ? 150 * 0.4 : width * 0.4;
    return Container(
      child: Stack(
        children: <Widget>[
          Container(
            ...
            decoration: BoxDecoration(
              border: Border(
                  top: BorderSide(color: widget.colorUnSelect!.withAlpha(30))),
          ...
          _button(marginTop, width, height1, iconSize1, 0),
          _button(marginTop, width, height1, iconSize1, 1),
          _centerButton(marginTop, width, height1, iconSize1, 2),
          _button(marginTop, width, height1, iconSize1, 3),
          _button(marginTop, width, height1, iconSize1, 4),
        ],
      ),
    );
  }

  _centerButton(double marginTop, double width, double height, double iconSize,
      int index) {
    return Stack(
      children: <Widget>[
        Container(
          ...
          child: IBoxCircle(
            ...
            color: widget.colorBackground!, press: () {  },
          ),
        ),
        Container(
  ...
  _button(double marginTop, double width, double height, double iconSize,
      int index) {
    return Stack(
      children: <Widget>[
        Container(
  ...
  _icon(double size, int index) {
    ...
    if (widget.icons!.length - 1 < index) return;
