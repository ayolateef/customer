...
import 'package:courierx/services/paystack-initializee.dart';
...
class _CheckoutMethodSelectableState extends State<CheckoutMethodSelectable> {
  ...
  void initState() {
    instance.initialize(
        publicKey: "pk_test_c94e821e90062228e94f6d39b7bf3492ee143ea7");
    super.initState();
  }
  ...
  chargeCard() async {
    ...
    Map accessCode = await createAccessCode("sk_test");
