...
import 'package:courierx/model/restourant.dart';
...
class _RestaurantDetailsScreenState extends State<RestaurantDetailsScreen>
  ...
  late Restourant _this;

  _load(String id) {
    for (var item in topRestourant) if (item.id == id) _this = item;
  }
