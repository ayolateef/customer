...
import 'package:courierx/model/topRestourants.dart';
...
import 'package:courierx/widget/icard10.dart';
import 'package:courierx/widget/icard11.dart';
...
import 'package:courierx/widget/ipromotion.dart';
import 'package:courierx/model/promotion.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  _children() {
    ...
    list.add(IPromotion(
      dataPromotion, height: windowWidth * 0.5, width: windowWidth * 0.9,
      colorActivy: theme.colorPrimary,
      style: theme.text22primaryShadow,
      buttonText: strings.get(97)!,
      buttonTextStyle: theme.text14boldWhite,
      pressButton: _pressPromotion, // Explore
      seconds: 4,
    ));
    ...
    list.add(Container(
      ...
      child: IList1(
          ...
          text: strings.get(39)!, // "Top Restaurants",
    ...
    list.add(Container(
      margin: EdgeInsets.only(left: 20),
      child: IList1(
          imageAsset: "assets/trending.png",
          text: strings.get(40)!, // "Trending this week",
          textStyle: theme.text16bold,
          imageColor: theme.colorDefaultText),
    ));
