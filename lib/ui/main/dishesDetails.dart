...
import 'package:courierx/model/dishes.dart';
import 'package:courierx/model/mostpopular.dart';
import 'package:courierx/model/review.dart';
import 'package:courierx/model/trending.dart';
import 'package:courierx/ui/main/home.dart';
import 'package:courierx/ui/menu/menu.dart';
import 'package:courierx/widget/iList6.dart';
import 'package:courierx/widget/ibox.dart';
import 'package:courierx/widget/iboxCircle.dart';
import 'package:courierx/widget/ibuttonCount.dart';
import 'package:courierx/widget/icard1.dart';
...
class _DishesDetailsScreenState extends State<DishesDetailsScreen>
  ...
  _load(String id) {
    for (var item in trending) if (item.id == id) _this = item;

    for (var item in mostPopular) if (item.id == id) _this = item;
  }
            ...
            headerSliverBuilder:
              ...
              return [
                SliverAppBar(
                  ...
                  title: Container(
                      child: Header(
                          nomenu: true, white: true, transparent: true, onMenuClick: (){},) // Home
                      ),
                )
              ];
            },
  ...
  _children() {
    ...
    list.add(Container(
      ...
      child: IList1(
        imageAsset: "assets/orders.png", text: _this.text!, // dish name
            ...
            child: Container(
              decoration: BoxDecoration(
                image: DecorationImage(
                    image: AssetImage(_this.image!), fit: BoxFit.cover),
              ),
            )),
      )),
    );
  ...
  _phone() {
    return Container(
      ...
      child: Row(
        children: <Widget>[
          Expanded(child: Text("Phone: 233 223 2334", style: theme.text14)),
          IInkWell(
            child: IBoxCircle(press: () {  },
            child: _icon()),
            onPress: _callMe,
          )
        ],
