...
import 'package:courierx/widget/icard8.dart';
...
class _PaymentScreenState extends State<PaymentScreen>
  ...
  _getList() {
    ...
    list.add(
      Container(
        ...
        child: IButtonBorder(
          text: strings.get(115)!,
          color: theme.colorPrimary, pressButton: _pressPayButton, pressButtonWithId: (int ) {  }, // Pay
        ),
      ),
    );
  ...
  _openDialog() {
    ...
    EasyDialog(
      ...
      titleLine: false,
      bodyLine: false,
      okText: strings.get(118)!, okColor: theme.colorPrimary,
      callbackPressOk: callbackDone, okButtonText: true,
    ).show(context);
  }
}
