...
import 'package:courierx/widget/iline.dart';
import 'package:courierx/widget/ilist5.dart';
import 'package:courierx/widget/label.dart';
  ...
  _onMenuClickItem(int id) {
    ...
    switch (id) {
      ...
      case 2: // notifications
        route.push(widget.context, "/notify");
        break;
      case 3: // My Orders
        widget.callback("orders");
        break;
      case 4: // Wish List
        widget.callback("favorites");
        break;
      case 7: // Help
        route.push(widget.context, "/help");
        break;
      case 8: // Settings
        widget.callback("account");
        break;
      case 9: // Language
        route.pushLanguage(widget.context, widget.callback as Function()?);
        break;
      ...
      case 11: // term of service
        route.push(widget.context, "/term");
        break;
    }
  }
    ...
    return Drawer(
      ...
      child: ListView(
        ...
        children: <Widget>[
          ...
          _itemWithNumber(3, strings.get(36)!, "assets/prod.png",
              pickup.length), // 'My orders'
          _item(4, strings.get(38)!, "assets/whatsapp1.png"), // "Favorites",
          ILine(),
