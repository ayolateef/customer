...
class _OnBoardingScreenState extends State<OnBoardingScreen>
  ...
  List<Page> pages = [
    Page(
        ...
        title: strings.get(164)!,
        bodyText: strings.get(167)!),
    Page(
        image: AssetImage('assets/shop2.png'),
        title: strings.get(165)!,
        bodyText: strings.get(168)!),
    Page(
        image: AssetImage('assets/shop3.png'),
        title: strings.get(166)!,
        bodyText: strings.get(169)!),
  ];
  ...
  var _lineHeight = 5.0;
  late DragStartDetails _dragStartPosition;
  ...
  _list() {
    ...
    for (int i = 0; i < pages.length; i++) {
      ...
      if (i == _curIndex2) color = theme.colorPrimary;
      list.add(Container(
      ...
      children: <Widget>[
        Container(
            ...
            child: Container(
              ...
              child: Image(image: _ib, fit: BoxFit.contain),
            )),
        Container(
            ...
            child: DecoratedBox(
              decoration: new BoxDecoration(
                  gradient: new LinearGradient(
                      ...
                      colors: <Color>[
                    theme.colorBackground.withAlpha(0),
        ...
        Container(
          margin: EdgeInsets.only(
            ...
            left: windowWidth > 800 ? (windowWidth / 2) - 600 / 2 : 30,
            right: windowWidth > 800 ? (windowWidth / 2) - 600 : 30,
          ),
          child: Column(
            children: <Widget>[
              Container(
